...
class Moderation(commands.Cog):
    ...
    async def _prefix(self, ctx: commands.Context, prefix):
          ...
          await ctx.reply(embed=discord.Embed(description=f"<:GreenTick:1018174649198202990> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .", color=0x00FFE4))

    @commands.hybrid_command(name="softban",help="Literally trolling command or you can use to clear all messages by the user.",usage="softban <member>")
    @blacklist_check()
    @commands.guild_only()
    @commands.has_permissions(ban_members=True)
    @commands.cooldown(1, 5, commands.BucketType.user)
    async def _softban(self, ctx: commands.Context, member: discord.Member, *, reason=None):
        ...
        hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | Sucessfully soft-banned {member}.", timestamp=ctx.message.created_at)
    ...
    async def mute(self,ctx: commands.Context, member: discord.Member, minutes: int, reason="None"):
    ...
    @commands.hybrid_command(name="kick",aliases=['k'],help="Somebody is breaking rules simply kick him from the server as punishment",usage="kick <member>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="roleallhumans",help="Gives a role to all the humans.")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    async def _roleallhumans(self,ctx: commands.Context,role:discord.Role):
    ...
    @commands.hybrid_command(name="roleallbots",help ="Gives a role to all the bots.")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    async def _roleallbots(self,ctx: commands.Context,role:discord.Role):
    ...
    @commands.hybrid_command(name="removeallhumans",help ="Removes a role from all the humans.")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    async def _removeallhumans(self,ctx: commands.Context,role:discord.Role):
    ...
    @commands.hybrid_command(name="removeallbots",help ="Removes a role from all the bots.")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    async def _removeallbots(self,ctx: commands.Context,role:discord.Role):
    ...
    @commands.hybrid_command(name="warn",help="To warn a specific user.",usage="warn <member>")
    @blacklist_check()
    @commands.has_permissions(kick_members=True)
    async def _warn(self, ctx: commands.Context, member: discord.Member, * , reason="No Reason Provided!"):
    ...
    @commands.hybrid_command(name="vcdeafen",help="To voice deafen a specific user.",usage="vcdeafen [member]")
    @blacklist_check()
    @commands.has_permissions(manage_messages=True)
    async def _vcdeafen(self, ctx: commands.Context, user: discord.Member, * , reason=None):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | {user.display_name} has been deafened, for: {reason}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.send(embed=hacker)
    ...
    @commands.hybrid_command(name="vcmute",help="To voice mute a specific user.",usage="vcmute [member]")
    @blacklist_check()
    @commands.has_permissions(manage_messages=True)
    async def _vcmute(self, ctx: commands.Context, member: discord.Member, * , reason=None):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | {member.display_name} has been muted, for: {reason}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.send(embed=hacker)
    ...
    @commands.hybrid_command(name="vcunmute",help="To voice unmute a specific user.",usage="vcunmute [member]")
    @blacklist_check()
    @commands.has_permissions(manage_messages=True)
    async def _vcunmute(self, ctx: commands.Context, member: discord.Member):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | {member.display_name} has been unmuted.", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.send(embed=hacker)
    ...
    @commands.hybrid_command(name="vcundeafen",help="To voice undeafen a specific user.",usage="vcundeafen [member]")
    @blacklist_check()
    @commands.has_permissions(manage_messages=True)
    async def _vcundeafen(self, ctx: commands.Context, member: discord.Member):
        hacker = discord.Embed(color=0x00FFE4,description=f"<a:black_astroz:1002204507985432666> | {member.display_name} has been undeafened.", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.send(embed=hacker)
    ...
    @commands.hybrid_command(name='ban', help="Somebody is breaking rules again and again | ban him from the server as punishment",usage="ban [member]")
    @blacklist_check()
    @commands.has_permissions(ban_members=True)
    async def _ban(self, ctx: commands.Context, member: discord.Member, *, reason=None):
        ...
        if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
            await member.ban(reason=reason)
            hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | {member.display_name} has been successfully banned", timestamp=ctx.message.created_at)
            #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
            hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url =f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
            ...
            await member.send(embed=hacker1)
        if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
            embed = discord.Embed(color=0x00FFE4,description=f"*<a:error:1002226340516331571> | You cannot ban someone with a higher role than you.*", timestamp=ctx.message.created_at)
            #embed.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
            #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
            await ctx.send(embed=embed)

  
    
    @commands.hybrid_command(name="unban",help="If someone realizes his mistake you should unban him",usage="unban [user]")
    @blacklist_check()
    @commands.has_permissions(ban_members=True)
    async def _unban(self, ctx: commands.Context, id: int):
        user = await self.bot.fetch_user(id)
        await ctx.guild.unban(user)
        hacker = discord.Embed(color=0x00FFE4,description=f"<:GreenTick:1029990379623292938> | {user.name} has been successfully unbanned", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.send(embed=hacker)
    ...
    @commands.hybrid_command(name="nick",aliases=['setnick'],help="To change someone's nickname.",usage="nick [member]")
    @blacklist_check()
    @commands.has_permissions(manage_nicknames=True)
    async def changenickname(self, ctx: commands.Context, member: discord.Member, * , nick):
    ...
    @commands.cooldown(1, 5, commands.BucketType.user)
    @commands.has_permissions(manage_channels=True)
    async def _nuke(self, ctx: commands.Context, channel: discord.TextChannel = None):
    ...
    async def _lock(self,
        ...
        try:
            ...
            await ctx.send(
                embed=discord.Embed(title="Astroz | Lockdown",
