...
class Fun(commands.Cog):
    ...
    @blacklist_check()
    @commands.command(name="tickle",help="Tickle mentioned user .",usage="Tickle <member>")
    ...
    @blacklist_check()
    @commands.command(name="kiss",help="Kiss mentioned user .",usage="Kiss <member>")
    ...
    @blacklist_check()            
    @commands.command(name="hug",help="Hug mentioned user .",usage="hug <member>")
    ...
    @commands.command(name="howgay",aliases=['gay'],help="check someone gay percentage",usage="Howgay <person>")
    @blacklist_check()
    ...
    @commands.command(name="penis",aliases = ['dick'],help="Check someone`s dick`s size .",usage="Dick [member]")
    @blacklist_check()
