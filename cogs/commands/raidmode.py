...
class Raidmode(Cog):
  ...
  @commands.hybrid_command(name="raidmode", aliases=["Automoderation"], help="Shows help about Automoderation feature of bot.")
  @blacklist_check()
  ...
  async def _antiraid(self, ctx: commands.Context):
    ...
    embed = discord.Embed(title="Astroz | Raidmode Commands",
color=0x00FFE4)  
    ...
    embed.add_field(name="<:ok_arrow:1024940412194005052> antilink on/off",
                    ...
                    inline=False)
    embed.add_field(name="<:ok_arrow:1024940412194005052> antinuke punishment set kick/ban/none",
  ...
  @commands.hybrid_command(name="antispam", aliases=['anti-spam'], help="Enables or Disables anti spam feature")
  @blacklist_check()
  ...
  @commands.hybrid_command(aliases=['anti-link'], name="antilink", help="Enables or Disables antilink feature")
  @blacklist_check()
