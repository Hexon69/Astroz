...
class General(commands.Cog):
    ...
    @commands.hybrid_command(name="afk",help="Changes your state to afk.",usage="Afk [reason]")
    @blacklist_check()
    async def afk(self, ctx: commands.Context, *, reason="I am afk."):
        member = ctx.author
...
Aliases"""
    ...
    @commands.hybrid_command(name="servericon",help="Shows the server icon",usage="Servericon")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="hack",help="hack someone's discord account",usage="Hack <member>")
    @blacklist_check()
    ...
    @commands.command(name="users",help="check users of astroz .")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="italicize",help="italicize the given text",usage="Italicize <message>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="strike",help="strike the given text",usage="Strike <message>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="quote",help="quote the given text",usage="Quote <message>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="code",help="code the given text",usage="Code <message>")
    @blacklist_check()
    async def code(self, ctx: commands.Context, *, message):
        await ctx.send('`' + message + "`")


    @commands.hybrid_command(name="bold",help="bold the given text",usage="Bold <message>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="censor",help="censor the given text",usage="Censor <message>")
    @blacklist_check()
    async def censor(self, ctx: commands.Context, *, message):
        await ctx.send('||' + message + '||')


    @commands.hybrid_command(name="underline",help="underline the given text",usage="Underline <message>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="pikachu",help="Gives a gif of pikachu",usage="Pikachu")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="shorten",help="Shortens specified url with 3 different url shorteners",usage="Shorten <url>")
    @blacklist_check()
    ...
    @commands.hybrid_command(name="urban",description="Searches for specified phrase on urbandictionary.com", help="Don't know meaning of some words don't worry this will help",usage="Urban <phrase>")
    @blacklist_check()
    ...
    @blacklist_check()
    @commands.hybrid_command(name="snipe", help="Snipes the most recent deleted message", usage="snipe")
    ...
    @commands.hybrid_command(name="roleall",help="Gives a role to all members", usage="roleall <role>", aliases=["role-all", "rall"])
    @blacklist_check()
    ...
    @commands.hybrid_command(name="jail", help="Jails a user", usage="jail <user>")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    ...
    @commands.hybrid_command(name="unjail", help="Unjails a user", usage="unjail <user>",  aliases=["free"])
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    ...
    @commands.hybrid_command(name="cleanup", help="deletes the bots messages", aliases=["purgebots"], usage="cleanup <amount>")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
