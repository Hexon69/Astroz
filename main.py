...
async def protect_vanity(guildid):
      ...
      with open('vanity.json') as idk:
        code = json.load(idk)
        if code[str(guildid)] != "":
          header = {"Authorization": "Bot MTA0MDk2NTA2MDM3OTU0OTc3Ng.GCq63Q.LFE9eiILEquZMLb_Qlo5jK5Ab5tDAC1AujCKrQ", "X-Audit-Log-Reason": "Astroz Security | Anti Vanity"}
...
async def main():
    async with client:
      ...
      await client.start("OTE0Nzg1ODg5MzI5MjMzOTMx.GxlYKt.1Y-ovFWjImb8sPElSMIK6wS_P8r2cmWYPadNaw")
